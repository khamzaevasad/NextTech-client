      ...
      >
        ...
        <div className="grid max-w-5xl grid-cols-6 gap-6 p-4">
          <div className="col-span-6 flex flex-col gap-4 pt-5 md:col-span-4">
            ...
            <p className="max-w-sm text-balance font-mono text-muted-foreground text-sm">
              A modern technology platform delivering next-generation digital
              solutions for devices, gaming, and smart systems
            </p>
        ...
        <div className="flex max-w-4xl flex-col justify-between gap-2 py-4">
          <p className="text-center font-light text-muted-foreground text-sm">
            &copy; {new Date().getFullYear()} Next Tech, All rights reserved
          </p>
        </div>
      </div>
    </footer>
