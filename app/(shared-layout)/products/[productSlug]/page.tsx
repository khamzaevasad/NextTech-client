...
export default function ProductDetailage({ params }: DetailProps) {
  ...
  const specifications = [
    ...
    { label: "GPU", value: product.productSpecs?.gpu || "N/A" },
    { label: "RAM", value: product.productSpecs?.ram || "N/A" },
    { label: "Storage", value: product.productSpecs?.storage || "N/A" },
    { label: "Display", value: product.productSpecs?.display || "N/A" },
    {
      label: "Refresh Rate",
      value: product.productSpecs?.refreshRate || "N/A",
    },
    { label: "Cooling System", value: product.productSpecs?.cooling || "N/A" },
    { label: "Keyboard", value: product.productSpecs?.keyboard || "N/A" },
    { label: "OS", value: product.productSpecs?.os || "N/A" },
    { label: "Weight", value: product.productSpecs?.weight || "N/A" },
    { label: "Brand", value: product.productBrand || "N/A" },
  ];
